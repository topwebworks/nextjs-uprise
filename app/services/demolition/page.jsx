...
import TWWDemolitionService from "@/components/homes/tww/TWWDemolitionService";

export const metadata = buildMetadata({
  title: "Concrete Demolition & Removal Client City AZ | Haul & Disposal | Client Business Name",
  description:
    "Concrete demolition, paver removal, turf & rock removal with full haul and disposal. Site assessment included, sub-grade left ready for the next install. Serving the surrounding service area AZ. Free estimates.",
                ...
                <div className="container position-relative">
                  <div className="row mb-50 mb-sm-50">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                      <h2 className="section-title-small mb-20">
                        Why choose Client for demolition &amp; removal?
                      </h2>
                  ...
                  <div className="row mt-n30 wow fadeInUp">
                    {[
                      ...
                      { icon: "mi-drop",            title: "Sub-Grade Left to Spec",    description: "When Client leaves a demolition site, the sub-grade is graded to elevation and drained away from the structure. The next install crew starts with an assessed, clean surface." },
                      ...
                      { icon: "mi-document-check",  title: "Licensed & Insured",        description: "AZ licensed hardscape contractor — License #000000. Every demolition job is fully insured from the first equipment move through final site turnover." },
                    ].map((elm, i) => (
                  ...
                  <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    >
                      <ImageBackground
                        ...
                        alt="Demolition and removal - Client Business Name"
