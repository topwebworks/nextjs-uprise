...
import TWWConcreteService from "@/components/homes/tww/TWWConcreteService";

export const metadata = buildMetadata({
  title: "Concrete Contractor Client City AZ | Driveways, Patios & RV Pads | Client Business Name",
  description:
    "Concrete driveways, patio slabs, RV pads, driveway extensions, repairs & full replacement. Serving Client City, Client City, Gilbert, Mesa, Chandler, Apache Junction & Maricopa AZ. Licensed License #000000. Free estimates.",
        ...
        <div className="page" id="top">
          ...
          <main id="main">
            <>
              ...
              <section className="page-section pt-0 z-index-1">
                <div className="container position-relative">
                  <div className="row mb-50 mb-sm-50">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                      <h2 className="section-title-small mb-20">
                        Why choose Client for concrete work?
                      </h2>
                  ...
                  <div className="row mt-n30 wow fadeInUp">
                    {[
                      { icon: "mi-layers",          title: "Subgrade Compacted First",   description: "Concrete cracks when the ground moves. Client excavates, removes organics, and compacts the subgrade before any forming begins — the step most contractors skip." },
              ...
              >
                <ImageBackground src="/assets/tww-assets/tww-images/Suburb_home_with_patio_pool_202605131833.jpeg" alt="" fixed />
                <div className="container position-relative">
                  <div className="row">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                  ...
                  <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    >
                      <ImageBackground
                        ...
                        alt="Concrete slab pour - Client Business Name"
