...
import TWWTurfService from "@/components/homes/tww/TWWTurfService";


export const metadata = buildMetadata({
  title: "Artificial Turf Installation Client City AZ | Turf & Natural Sod | Client Business Name",
  description:
    "Artificial turf and natural sod installation for backyards, front yards, pet runs & play areas. Proper sub-base, drainage & seaming. Serving the surrounding service area AZ. Free estimates.",
        ...
        <div className="page" id="top">
          ...
          <main id="main">
            <>
                ...
                <div className="container position-relative">
                  <div className="row mb-50 mb-sm-50">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                      <h2 className="section-title-small mb-20">
                        Why choose Client for turf installation?
                      </h2>
                  ...
                  <div className="row mt-n30 wow fadeInUp">
                    {[
                      ...
                      { icon: "mi-document-check",  title: "Licensed & Insured",         description: "AZ licensed hardscape contractor — License #000000. Every turf job is fully insured from excavation through final walkthrough." },
                    ].map((elm, i) => (
              ...
              >
                <ImageBackground src="/assets/tww-assets/tww-images/Suburb_home_with_patio_pool_202605131833_3.jpeg" alt="" fixed />
                <div className="container position-relative">
                  <div className="row">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                  ...
                  <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    >
                      <ImageBackground
                        ...
                        alt="Turf installation - Client Business Name"
