...
import TWWRockService from "@/components/homes/tww/TWWRockService";

export const metadata = buildMetadata({
  title: "Decorative Rock Installation Client City AZ | Desert Rock & DG | Client Business Name",
  description:
    "Decorative rock, decomposed granite & accent boulder installation. Site prep, weed barrier, metal edging & proper drainage. Serving Client City, Client City, Gilbert, Mesa, Chandler, Apache Junction & Maricopa AZ. Free estimates.",
        ...
        <div className="page" id="top">
          ...
          <main id="main">
            <>
              ...
              >
                <ImageBackground src="/assets/tww-assets/tww-images/Arizona_house_installing_pool_backyard_202605131833.jpeg" alt="" fixed priority />
                ...
                <div className="container position-relative">
                  <div className="row mb-50 mb-sm-50">
                    <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                      <h2 className="section-title-small mb-20">
                        Why choose Client for decorative rock?
                      </h2>
                      <p className="text-gray mb-0">
                        The grade, the barrier, the edging, and how the rock field integrates with every adjacent surface — that&rsquo;s the work. That&rsquo;s what Client gets right before the first stone is placed.
                      </p>
                    </div>
                  </div>
                  <div className="row mt-n30 wow fadeInUp">
                    {[
                      ...
                      { icon: "mi-document-check",  title: "Licensed & Insured",         description: "AZ licensed hardscape contractor — License #000000. Every decorative rock job is fully insured from the first site visit through final walkthrough." },
                    ].map((elm, i) => (
