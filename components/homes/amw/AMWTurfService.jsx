    ...
    <div className="container position-relative">
      <style>{`
        ...
        @media (max-width: 1100px) {
          .tsvc-tabs-desktop { display: none !important; }
          .tsvc-tabs-mobile {
        ...
        .tsvc-tabs-mobile { display: none; }
        @media (max-width: 991px) {
          .tsvc-tabs-mobile { max-width: 100% !important; }
          .services-text { margin-top: 0 !important; }
          .services-text-container { margin-left: 0 !important; }
          .tsvc-img-col { margin-top: 40px !important; }
        }
        @media (max-width: 767px) {
          .tsvc-img-col { margin-top: 32px !important; }
        }
