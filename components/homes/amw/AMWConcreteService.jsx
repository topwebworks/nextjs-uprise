    ...
    <div className="container position-relative">
      <style>{`
        ...
        @media (max-width: 1100px) {
          .csvc-tabs-desktop { display: none !important; }
          .csvc-tabs-mobile {
        ...
        .csvc-tabs-mobile { display: none; }
        @media (max-width: 991px) {
          .csvc-tabs-mobile { max-width: 100% !important; }
          .services-text { margin-top: 0 !important; }
          .services-text-container { margin-left: 0 !important; }
          .csvc-img-col { margin-top: 40px !important; }
        }
        @media (max-width: 767px) {
          .csvc-img-col { margin-top: 32px !important; }
        }
        @media (max-width: 575px) {
          .services-tabs li { margin-bottom: 4px !important; }
          .services-tabs a { font-size: 20px !important; padding: 6px 0 !important; display: block; }
