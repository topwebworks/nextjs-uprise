...
import "@/components/homes/tww/TWWConcreteService.module.css";
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Need more parking without a full driveway replacement? Client extends and widens existing concrete driveways with new pours that match the existing slab's elevation, finish, and joint pattern. We tie the new pour to the old with proper isolation joints so they move independently.",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "When replacement is the right call, Client handles full tearout, haul-away, subgrade prep, and new pour — all under one project. No coordinating separate demolition and concrete crews. We address whatever caused the original failure before the new slab goes in.",
...
export default function TWWConcreteService() {
          ...
          <div className="row">
            <div className="col-lg-10">
              <p className="section-descr mb-20 mb-sm-20 wow fadeInUp" data-wow-delay="0.4s">
                Client handles the full scope of residential concrete — new driveways, patio slabs, RV pads, driveway extensions, repairs, and full replacements. Every job is one crew from demolition through pour, and every pour starts the same way: grade checked, subgrade compacted, forms set right before the truck arrives.
              </p>
            </div>
          </div>
