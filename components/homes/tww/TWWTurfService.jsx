...
import "@/components/homes/tww/TWWTurfService.module.css";
...
const services = [
  ...
  },
  {
    ...
    description:
      "Client installs natural sod. For properties where natural grass is the right call — HOA requirements, shaded yards, cooler microclimates, or client preference — we handle the full install from soil prep through sod placement.",
    cards: [
      {
        image: "/assets/tww-assets/tww-images/Suburb_home_with_patio_pool_202605131833_5.jpeg",
        heading: "Soil Prep & Grade",
        body: "Natural sod lives or dies by what's underneath it. Client amends the existing soil where needed — Arizona native soil is typically compacted caliche or sandy loam with low organic content that doesn't establish sod well without preparation. We till, amend with compost, establish grade for positive drainage, and roll the soil firm before sod goes down. Sod laid on uneven or unamended soil fails to root evenly and shows seams and dead patches within one growing season.",
      ...
      },
      {
        ...
        body: "Bermuda is the dominant warm-season sod in the Service Area — it handles Arizona heat, recovers fast from traffic, and establishes quickly. Hybrid Bermudas like Tifway 419 and TifTuf are denser, finer-bladed, and more drought-tolerant than common Bermuda. Bermuda goes dormant and turns tan in winter — clients who want year-round green typically overseed with perennial ryegrass in October. For shaded areas where Bermuda won't establish, St. Augustine is the viable alternative. We match the variety to the yard's sun exposure, soil, water budget, and intended use.",
...
export default function TWWTurfService() {
