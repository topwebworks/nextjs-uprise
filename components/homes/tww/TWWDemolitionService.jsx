...
import "@/components/homes/tww/TWWDemolitionService.module.css";
...
const services = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Every demolition job has a defined scope and a defined boundary. Client marks what stays before equipment moves. Adjacent pavers, concrete edges, irrigation heads, and landscaping near the demolition zone are protected or marked for avoidance before work starts. Damage to adjacent surfaces during demolition is a scope failure, not an accident — it's what happens when no one defines the boundary before the work begins.",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Not every concrete removal job is a full tear-out. When a client is extending a patio, adding a driveway section, or matching into existing flatwork, Client saw-cuts a clean, straight line at the remove/retain boundary before demolition begins. A clean saw cut gives the new pour a proper edge to butt against. Demolition work that just breaks to a ragged edge and patches it creates a visible seam and a weak joint that cracks again within a few years.",
...
export default function TWWDemolitionService() {
          ...
          <div className="row">
            <div className="col-lg-10">
              <p className="section-descr mb-20 mb-sm-20 wow fadeInUp" data-wow-delay="0.4s">
                Every new hardscape install starts with removing what&rsquo;s there. Client handles demolition as a full scope — site assessment, defined boundaries, proper removal method for the material, and a sub-grade handed off clean and ready for the next install.
              </p>
            </div>
          </div>
