...
import "@/components/homes/tww/TWWRockService.module.css";
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "Decorative rock is permeable — water moves through it. What it moves into is the sub-grade, and the sub-grade is what determines where water actually goes. Client establishes drainage slope at the sub-grade stage, before the barrier goes down. Any slope error made here is permanent once the rock is placed. Surface pooling on a finished decorative rock install is never a rock problem — it's a sub-grade grade failure, and fixing it means pulling the rock, pulling the barrier, and re-grading from scratch.",
    ...
    cards: [
      {
        ...
        body: "Where decorative rock meets a paver field, the transition needs a hard stop — typically a soldier course set tight against the edging, or a buried concrete mow strip — to keep the materials from mixing over time. Monsoon water and foot traffic will always push loose material toward lower or softer surfaces. Client details every paver-to-rock transition so the paver field stays clean and the rock field stays contained through years of weather. A paver border with rock fill is one of the most durable and low-maintenance combinations in Arizona residential hardscape — pavers where you walk, rock where you don't.",
...
export default function TWWRockService() {
          ...
          <div className="row">
            <div className="col-lg-10">
              <p className="section-descr mb-20 mb-sm-20 wow fadeInUp" data-wow-delay="0.4s">
                Every decorative rock job Client installs starts with a site assessment, a graded sub-base, commercial barrier, and properly detailed edging. The grade, the barrier, the containment, and how the rock field integrates with everything else on the property are what determine whether an install holds together for ten years or starts failing after the first monsoon season.
              </p>
            </div>
          </div>
